...
const Contact = () => {
  return (
    ...
    >
      <div className="max-w-md w-full bg-slate-800/40 backdrop-blur-lg rounded-2xl shadow-2xl p-8 text-center border border-purple-600/30 transition-transform duration-300 hover:scale-105">
